...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Blog::factory(2)->create(['user_id'=>$james->id,'category_id'=>$workouts->id,'tag_id'=>$lifestyle->id]);
        Blog::factory(3)->create(['user_id'=>$miya->id,'category_id'=>$recipes->id,'tag_id'=>$food->id]);
