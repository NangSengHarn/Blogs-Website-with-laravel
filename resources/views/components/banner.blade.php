<section class="bannerbg d-flex justify-content-center align-items-center" style="padding-top: 70px;" id="banner">
    <div class="card p-3 rounded-3 shadow-sm" style="width: 30rem;">
        <div class="card-body text-center">
          ...
          <a href="#posts" class="btn btn-primary">Go to blogs</a>
        </div>
    </div>
</section>
